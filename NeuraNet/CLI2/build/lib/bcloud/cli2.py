...
def connect_to_relay_server():
    #RELAY_HOST = '35.226.134.169'  # Change to the relay server's address if it's running on a different machine

    RELAY_HOST = '0.0.0.0'  # Change to the relay server's address if it's running on a different machine
    RELAY_PORT = 8008
